...
static const AVOption aiir_options[] = {
    ...
    { "gains", "set channels gains",               OFFSET(gains), AV_OPT_TYPE_DOUBLE|AR, {.arr=&def_gains}, -900, 900, AF },
    { "k", "set channels gains",                   OFFSET(gains), AV_OPT_TYPE_DOUBLE|AR, {.arr=&def_gains}, -900, 900, AF },
