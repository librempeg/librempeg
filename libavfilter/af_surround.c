...
static const AVOption surround_options[] = {
    ...
    { "spread_x",  "set channels X-axis spread",         OFFSET(f_x),      AV_OPT_TYPE_FLOAT|AR, {.arr=&def_f_x}, 0.0, 15, TFLAGS },
    { "spread_y",  "set channels Y-axis spread",         OFFSET(f_y),      AV_OPT_TYPE_FLOAT|AR, {.arr=&def_f_y}, 0.0, 15, TFLAGS },
    { "spread_z",  "set channels Z-axis spread",         OFFSET(f_z),      AV_OPT_TYPE_FLOAT|AR, {.arr=&def_f_z}, 0.0, 15, TFLAGS },
