...
static const AVOption volume_options[] = {
    ...
    { "precision", "select mathematical precision",
        ...
        { "fixed",  "select 8-bit fixed-point",     0, AV_OPT_TYPE_CONST, { .i64 = PRECISION_FIXED  }, 0, 0, A|F, .unit = "precision" },
        { "float",  "select 32-bit floating-point", 0, AV_OPT_TYPE_CONST, { .i64 = PRECISION_FLOAT  }, 0, 0, A|F, .unit = "precision" },
        { "double", "select 64-bit floating-point", 0, AV_OPT_TYPE_CONST, { .i64 = PRECISION_DOUBLE }, 0, 0, A|F, .unit = "precision" },
