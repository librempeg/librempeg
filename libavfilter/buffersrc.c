...
typedef struct BufferSourceContext {
    ...
    int channels;
    AVChannelLayout channel_layout_opt;
...
static const AVOption buffer_options[] = {
    ...
    {   "gbr",         NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_RGB},               0, 0, V, .unit = "colorspace"},
    {   "bt709",       NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_BT709},             0, 0, V, .unit = "colorspace"},
    {   "unknown",     NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_UNSPECIFIED},       0, 0, V, .unit = "colorspace"},
    {   "fcc",         NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_FCC},               0, 0, V, .unit = "colorspace"},
    {   "bt470bg",     NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_BT470BG},           0, 0, V, .unit = "colorspace"},
    {   "smpte170m",   NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_SMPTE170M},         0, 0, V, .unit = "colorspace"},
    {   "smpte240m",   NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_SMPTE240M},         0, 0, V, .unit = "colorspace"},
    {   "ycgco",       NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_YCGCO},             0, 0, V, .unit = "colorspace"},
    {   "ycgco-re",    NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_YCGCO_RE},          0, 0, V, .unit = "colorspace"},
    {   "ycgco-ro",    NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_YCGCO_RO},          0, 0, V, .unit = "colorspace"},
    {   "bt2020nc",    NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_BT2020_NCL},        0, 0, V, .unit = "colorspace"},
    {   "bt2020c",     NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_BT2020_CL},         0, 0, V, .unit = "colorspace"},
    {   "smpte2085",   NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_SMPTE2085},         0, 0, V, .unit = "colorspace"},
    {   "chroma-derived-nc",  NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_CHROMA_DERIVED_NCL},0, 0, V, .unit = "colorspace"},
    {   "chroma-derived-c",   NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_CHROMA_DERIVED_CL}, 0, 0, V, .unit = "colorspace"},
    {   "ictcp",       NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_ICTCP},             0, 0, V, .unit = "colorspace"},
    {   "ipt-c2",      NULL,  0, AV_OPT_TYPE_CONST, {.i64=AVCOL_SPC_IPT_C2},            0, 0, V, .unit = "colorspace"},
...
static const AVOption abuffer_options[] = {
    ...
    { "channel_layout", NULL, OFFSET(channel_layout_opt),  AV_OPT_TYPE_CHLAYOUT, .flags = A },
...
static av_cold int init_audio(AVFilterContext *ctx)
{
    ...
    if (s->channel_layout_opt.nb_channels || s->ch_layout.nb_channels) {
        int n;

        if (!s->ch_layout.nb_channels) {
            ret = av_channel_layout_copy(&s->ch_layout, &s->channel_layout_opt);
        }
