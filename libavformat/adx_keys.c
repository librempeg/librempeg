...
static const ADXKeyInfo adx8_keys[] = {
    {0x49e1,0x4a57,0x553d, "karaage",0},
    {0x5f5d,0x58bd,0x55ed, "LOVELOVE",0},
    ...
    {0x60ad,0x5689,0x5281, "\x83\x76\x83\x89\x83\x60\x83\x69Lovers_Day",0},
};

static const ADXKeyInfo adx9_keys[] = {
    {0x07d2,0x1ec5,0x0c7f, NULL,0},
    {0x0003,0x0d19,0x043b, NULL,416383518},
    {0x0005,0x0bcd,0x1add, NULL,683461999},
    {0x0000,0x2b99,0x3e33, NULL,45719322},
    {0x0000,0x12fd,0x1fbd, NULL,19910623},
    {0x5e4b,0x190d,0x76bb, NULL,145552191146490718},
    {0x3f10,0x3651,0x6d31, NULL,4867249871962584729},
    {0x5152,0x7979,0x152b, NULL,165521992944278},
    {0x03fc,0x0749,0x12EF, NULL,0},
    {0x2669,0x1495,0x2407, NULL,0x55D11D3349495204},
    {0x2378,0x5511,0x0201, NULL,5613126134333697},
    {0x0613,0x0e3d,0x6dff, NULL,1175268187653273344},
    {0x0000,0x1c85,0x7043, NULL,29915170},
    {0x0000,0x0000,0x0000, NULL,10882899},
    {0x0000,0x0000,0x0000, NULL,22759300},
    {0x0000,0x0000,0x0000, NULL,6349046567469313},
    {0x0000,0x0000,0x0000, NULL,9170825592834449000},
    {0x0000,0x0000,0x0000, NULL,1991062320101111},
    {0x0000,0x0000,0x0000, NULL,1731948526},
    {0x0000,0x0000,0x0000, NULL,9923540143823782},
    {0x0000,0x0000,0x0000, NULL,301179795002661},
    {0x0000,0x0000,0x0000, NULL,1655728931134731873},
};
...
static void cri_key8_derive(const char *key8, uint16_t *p_key1, uint16_t *p_key2, uint16_t *p_key3)
{
...
static void cri_key9_derive(uint64_t key9, uint16_t subkey,
                            uint16_t *p_key1, uint16_t *p_key2, uint16_t *p_key3)
{
    uint16_t key1 = 0, key2 = 0, key3 = 0;
...
{
    int keycount = 0, keymask = 0, ret = 0;
    const ADXKeyInfo *keys;

    if (type == 8) {
        keys = adx8_keys;
        keycount = FF_ARRAY_ELEMS(adx8_keys);
        keymask = 0x6000;
    } else if (type == 9) {
        keys = adx9_keys;
        keycount = FF_ARRAY_ELEMS(adx9_keys);
        keymask = 0x1000;
    } else {
