...
static int binka_ue_probe(const AVProbeData *p)
{
...
static int binka_ue_read_header(AVFormatContext *s)
{
    AVIOContext *pb = s->pb;
    AVStream *st;
...
static int binka_ue_read_packet(AVFormatContext *s, AVPacket *pkt)
{
    AVIOContext *pb = s->pb;
...
const FFInputFormat ff_binka_ue_demuxer = {
    .p.name         = "binka_ue",
    .p.long_name    = NULL_IF_CONFIG_SMALL("Unreal Engine Bink Audio"),
    .p.flags        = AVFMT_GENERIC_INDEX,
    .read_probe     = binka_ue_probe,
    .read_header    = binka_ue_read_header,
    .read_packet    = binka_ue_read_packet,
};
