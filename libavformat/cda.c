...
static int cda_probe(const AVProbeData *p)
{
...
const FFInputFormat ff_cda_demuxer = {
    .p.name         = "cda",
    .p.long_name    = NULL_IF_CONFIG_SMALL("CDA (Compact Disc Audio)"),
    .read_probe     = cda_probe,
    .read_header    = cda_read_header,
