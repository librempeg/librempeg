...
{
    if (AV_RB32(p->buf) != MKBETAG('W','S','S','0'))
        return 0;
...
const FFInputFormat ff_wss_demuxer = {
    .p.name         = "wss",
    .p.long_name    = NULL_IF_CONFIG_SMALL("Bohemia Interactive WSS"),
