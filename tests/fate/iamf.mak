...
FATE_IAMF-$(call TRANSCODE, FLAC, IAMF, WAV_DEMUXER PCM_S16LE_DECODER ASF2SF_FILTER) += fate-iamf-5_1_4
...
FATE_IAMF-$(call TRANSCODE, FLAC, IAMF, WAV_DEMUXER PCM_S16LE_DECODER ASF2SF_FILTER) += fate-iamf-7_1_4
...
FATE_IAMF-$(call TRANSCODE, FLAC, IAMF, WAV_DEMUXER PCM_S16LE_DECODER ASF2SF_FILTER) += fate-iamf-9_1_6
...
FATE_IAMF-$(call TRANSCODE, FLAC, IAMF, WAV_DEMUXER PCM_S16LE_DECODER ASF2SF_FILTER) += fate-iamf-ambisonic_1
...
FATE_IAMF-$(call TRANSCODE, FLAC, IAMF, WAV_DEMUXER PCM_S16LE_DECODER ASF2SF_FILTER) += fate-iamf-ambisonic_1-projection
