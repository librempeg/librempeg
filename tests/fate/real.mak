...
FATE_REALMEDIA_AUDIO-$(call PCM, RM, RA_288, ASF2SF_FILTER) += fate-ra-288
fate-ra-288: CMD = pcm -i $(TARGET_SAMPLES)/real/ra_288.rm
fate-ra-288: CMP = oneoff
fate-ra-288: REF = $(SAMPLES)/real/ra_288.pcm
fate-ra-288: FUZZ = 2

FATE_REALMEDIA_AUDIO-$(call PCM, RM, COOK, ASF2SF_FILTER) += fate-ra-cook
...
FATE_REALMEDIA_AUDIO-$(call PCM, RM, SIPR, ASF2SF_FILTER) += $(FATE_SIPR)
fate-sipr: $(FATE_SIPR)
