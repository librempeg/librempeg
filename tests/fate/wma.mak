FATE_WMAPRO-$(call PCM, ASF, WMAPRO, ASF2SF_FILTER) += fate-wmapro-2ch
...
FATE_WMAPRO-$(call PCM, ASF, WMAPRO, ASF2SF_FILTER) += fate-wmapro-5.1
...
FATE_WMAPRO-$(call PCM, MOV, WMAPRO, ASF2SF_FILTER) += fate-wmapro-ism
...
FATE_WMAVOICE-$(call PCM, ASF, WMAVOICE, ASF2SF_FILTER) += fate-wmavoice-7k
...
FATE_WMAVOICE-$(call PCM, ASF, WMAVOICE, ASF2SF_FILTER) += fate-wmavoice-11k
...
FATE_WMAVOICE-$(call PCM, ASF, WMAVOICE, ASF2SF_FILTER) += fate-wmavoice-19k
...
FATE_WMA_ENCODE-$(call ENCDEC, WMAV1, ASF, ASF2SF_FILTER PIPE_PROTOCOL) += fate-wmav1-encode
...
FATE_WMA_ENCODE-$(call ENCDEC, WMAV2, ASF, ASF2SF_FILTER PIPE_PROTOCOL) += fate-wmav2-encode
