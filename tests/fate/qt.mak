FATE_QT-$(call FRAMECRC, MOV, EIGHTBPS, SCALE_FILTER ASF2SF_FILTER) += fate-8bps
fate-8bps: CMD = framecrc -i $(TARGET_SAMPLES)/8bps/full9iron-partial.mov -pix_fmt rgb24 -vf scale -af asf2sf
...
FATE_QT-$(call ENCDEC, PCM_S16LE ADPCM_IMA_QT, PCM_S16LE MOV, ASF2SF_FILTER) += fate-qt-ima4-mono
fate-qt-ima4-mono: CMD = md5 -i $(TARGET_SAMPLES)/qt-surge-suite/surge-1-16-B-ima4.mov -f s16le -af asf2sf

FATE_QT-$(call ENCDEC, PCM_S16LE ADPCM_IMA_QT, PCM_S16LE MOV, ASF2SF_FILTER) += fate-qt-ima4-stereo
fate-qt-ima4-stereo: CMD = md5 -i $(TARGET_SAMPLES)/qt-surge-suite/surge-2-16-B-ima4.mov -f s16le -af asf2sf

FATE_QT-$(call ENCDEC, PCM_S16LE MACE3, PCM_S16LE MOV, ASF2SF_FILTER) += fate-qt-mac3-mono
fate-qt-mac3-mono: CMD = md5 -i $(TARGET_SAMPLES)/qt-surge-suite/surge-1-8-MAC3.mov -f s16le -af asf2sf

FATE_QT-$(call ENCDEC, PCM_S16LE MACE3, PCM_S16LE MOV, ASF2SF_FILTER) += fate-qt-mac3-stereo
fate-qt-mac3-stereo: CMD = md5 -i $(TARGET_SAMPLES)/qt-surge-suite/surge-2-8-MAC3.mov -f s16le -af asf2sf

FATE_QT-$(call ENCDEC, PCM_S16LE MACE6, PCM_S16LE MOV, ASF2SF_FILTER) += fate-qt-mac6-mono
fate-qt-mac6-mono: CMD = md5 -i $(TARGET_SAMPLES)/qt-surge-suite/surge-1-8-MAC6.mov -f s16le -af asf2sf

FATE_QT-$(call ENCDEC, PCM_S16LE MACE6, PCM_S16LE MOV, ASF2SF_FILTER) += fate-qt-mac6-stereo
fate-qt-mac6-stereo: CMD = md5 -i $(TARGET_SAMPLES)/qt-surge-suite/surge-2-8-MAC6.mov -f s16le -af asf2sf
