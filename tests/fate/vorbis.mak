...
FATE_VORBIS-$(call PCM, OGG, VORBIS, ASF2SF_FILTER) += $(FATE_VORBIS)
FATE_VORBIS_ENCODE-$(call TRANSCODE, VORBIS, OGG, WAV_MUXER WAV_DEMUXER PCM_S16LE_DECODER ASF2SF_FILTER) += $(FATE_VORBIS_ENCODE)
