...
FATE_ATRAC1-$(call PCM, AEA, ATRAC1, ASF2SF_FILTER) += $(FATE_ATRAC1)
...
FATE_ATRAC3-$(call PCM, WAV, ATRAC3, ASF2SF_FILTER) += $(FATE_ATRAC3)
...
fate-atrac3p-2: FUZZ = 394

FATE_ATRAC3P-$(call PCM, OMA, ATRAC3P, ASF2SF_FILTER) += $(FATE_ATRAC3P)
