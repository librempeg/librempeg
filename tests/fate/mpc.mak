...
FATE_MPC-$(call PCM, MPC, MPC7, ASF2SF_FILTER) += fate-musepack7
...
FATE_MPC-$(call ALLYES, MPC8_DEMUXER MPC8_DECODER  \
                        ASF2SF_FILTER PCM_S16LE_ENCODER  \
                        FRAMECRC_MUXER PIPE_PROTOCOL) += fate-musepack8
fate-musepack8: CMD = pcm -i $(TARGET_SAMPLES)/musepack/inside-mp8.mpc -ss 8.4 -af asf2sf
