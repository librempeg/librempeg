...
FATE_GENERIC_TAGS-$(call REMUX, MP3, FLAC_MUXER FLAC_DEMUXER FLAC_ENCODER FLAC_DECODER ASF2SF_FILTER) += fate-generic-tags-remux-vorbiscomment
fate-generic-tags-remux-vorbiscomment: tests/data/generic-tags.mp3
fate-generic-tags-remux-vorbiscomment: CMD = generic_tags mp3 $(TARGET_PATH)/tests/data/generic-tags.mp3 flac flac "-t 0 -af asf2sf -strict experimental"
...
FATE_GENERIC_TAGS-$(call REMUX, MP3, WAV_MUXER WAV_DEMUXER PCM_S16LE_ENCODER PCM_S16LE_DECODER ASF2SF_FILTER) += fate-generic-tags-remux-riff
fate-generic-tags-remux-riff: tests/data/generic-tags.mp3
fate-generic-tags-remux-riff: CMD = generic_tags mp3 $(TARGET_PATH)/tests/data/generic-tags.mp3 wav pcm_s16le "-t 0 -af asf2sf"
