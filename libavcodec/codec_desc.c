...
static const AVCodecDescriptor codec_descriptors[] = {
    ...
    {
        .id        = AV_CODEC_ID_VICAR,
        .type      = AVMEDIA_TYPE_VIDEO,
        .name      = "vicar",
        .long_name = NULL_IF_CONFIG_SMALL("VICAR (Video Image Communication And Retrieval)"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSLESS,
    },
    {
        .id        = AV_CODEC_ID_APV,
    ...
    },
    {
        ...
        .type      = AVMEDIA_TYPE_VIDEO,
        .name      = "qon",
        .long_name = NULL_IF_CONFIG_SMALL("QON (Quite OK aNimation)"),
        .props     = AV_CODEC_PROP_LOSSLESS,
    },
    {
        .id        = AV_CODEC_ID_BVC2,
        .type      = AVMEDIA_TYPE_VIDEO,
        .name      = "bvc2",
        .long_name = NULL_IF_CONFIG_SMALL("byteVC2"),
        .props     = AV_CODEC_PROP_LOSSY | AV_CODEC_PROP_REORDER,
        .profiles  = NULL_IF_CONFIG_SMALL(ff_vvc_profiles),
    },
    {
    ...
    {
        .id        = AV_CODEC_ID_TTVIDEO,
        .type      = AVMEDIA_TYPE_VIDEO,
        .name      = "ttvideo",
        .long_name = NULL_IF_CONFIG_SMALL("Traveller's Tales Video"),
        .props     = AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ECM,
    ...
    {
        .id        = AV_CODEC_ID_PCM_SONIC,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "pcm_sonic",
        .long_name = NULL_IF_CONFIG_SMALL("PCM Sonic"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSLESS,
    },
    {
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_PT,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_pt",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Wwise Platinum"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_TANTALUS,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_tantalus",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Tantalus"),
        .props     = AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_FMOD,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_fmod",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM FMOD"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_MO,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_mo",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA MobiClip MO"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_BRR,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_brr",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Bit Rate Reduction"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_NDSP,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ndsp",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Nintendo DSP"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_NDSP_LE,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ndsp_le",
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_ZMUSIC,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_zmusic",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA Z-Music"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_PROCYON,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_procyon",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Procyon"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_DSA,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_dsa",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Ocean DSA"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_MPC3,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_mpc3",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Paradigm Entertainment MPC3"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_DVI,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_dvi",
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_CFDF,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_cfdf",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Cyberflix DreamFactory CFDF"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_HWAS,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_hwas",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA Nintendo DS HWAS"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_WAV_MONO,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_wav_mono",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA WAV (Mono)"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_WV6,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_wv6",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA WV6"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_XBOX_MONO,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_xbox_mono",
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_WW,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_ww",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA Audiokinetic Wwise"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_NXAP,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_nxap",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM NXAP"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_XA8,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_xa8",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM CDROM XA 8-bit"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_REF,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_ref",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA Reflections"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_OKI4,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_oki4",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA Dialogic OKI (4-shift)"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima",
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_RAUD,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_raud",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA RAUD"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_TRA,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_tra",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA TRA"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_CKMK,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ckmk",
    ...
    {
        .id        = AV_CODEC_ID_ADPCM_IMA_XBOX_SBR,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ima_xbox_sbr",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM IMA Xbox (Saber)"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_ADPCM_MS_MONO,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "adpcm_ms_mono",
        .long_name = NULL_IF_CONFIG_SMALL("ADPCM Microsoft (Mono)"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    ...
    {
        .id        = AV_CODEC_ID_BIS_DPCM,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "bis_dpcm",
        .long_name = NULL_IF_CONFIG_SMALL("DPCM Bohemia Interactive"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    ...
    },
    {
        ...
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "tac",
        .long_name = NULL_IF_CONFIG_SMALL("tri-Ace audio"),
        .props     = AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_AHX,
    ...
    {
        .id        = AV_CODEC_ID_EALAYER3MULTI,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "ealayer3multi",
        .long_name = NULL_IF_CONFIG_SMALL("Electronic Arts Layer3 multichannel"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
    ...
    },
    {
        ...
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "rada",
        .long_name = NULL_IF_CONFIG_SMALL("RAD Audio"),
        .props     = AV_CODEC_PROP_INTRA_ONLY | AV_CODEC_PROP_LOSSY,
    },
    {
        .id        = AV_CODEC_ID_COMPRESSWAVE,
        .type      = AVMEDIA_TYPE_AUDIO,
        .name      = "compresswave",
