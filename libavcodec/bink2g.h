                              ...
                              int flags, int tdc[16])
{
    ...
    if (is_luma && (flags & 0x20) && (flags & 0x80)) {
        dc[0]  = (mindc < 0 ? 0 : 1024) + tdc[0];
        dc[1]  = dc[0] + tdc[1];
        dc[2]  = DC_MPRED2(dc[0], dc[1]) + tdc[2];
        dc[3]  = DC_MPRED(dc[0], dc[2], dc[1]) + tdc[3];
        dc[4]  = DC_MPRED2(dc[1], dc[3]) + tdc[4];
        dc[5]  = dc[4] + tdc[5];
        dc[6]  = DC_MPRED(dc[1], dc[3], dc[4]) + tdc[6];
        dc[7]  = DC_MPRED(dc[4], dc[6], dc[5]) + tdc[7];
        dc[8]  = DC_MPRED2(dc[2], dc[3]) + tdc[8];
        dc[9]  = DC_MPRED(dc[2], dc[8], dc[3]) + tdc[9];
        dc[10] = DC_MPRED2(dc[8], dc[9]) + tdc[10];
        dc[11] = DC_MPRED(dc[8], dc[10], dc[9]) + tdc[11];
        dc[12] = DC_MPRED(dc[3], dc[9], dc[6]) + tdc[12];
        dc[13] = DC_MPRED(dc[6], dc[12], dc[7]) + tdc[13];
        dc[14] = DC_MPRED(dc[9], dc[11], dc[12]) + tdc[14];
        dc[15] = DC_MPRED(dc[12], dc[14], dc[13]) + tdc[15];
    } else if (is_luma && (flags & 0x80)) {
        dc[0]  = DC_MPRED2(Ldc[5], Ldc[7]) + tdc[0];
        dc[1]  = dc[0] + tdc[1];
        dc[2]  = DC_MPRED(Ldc[5], Ldc[7], dc[0]) + tdc[2];
        dc[3]  = DC_MPRED(dc[0], dc[2], dc[1]) + tdc[3];
        dc[4]  = DC_MPRED2(dc[1], dc[3]) + tdc[4];
        dc[5]  = dc[4] + tdc[5];
        dc[6]  = DC_MPRED(dc[1], dc[3], dc[4]) + tdc[6];
        dc[7]  = DC_MPRED(dc[4], dc[6], dc[5]) + tdc[7];
        dc[8]  = DC_MPRED(Ldc[7], Ldc[13], dc[2]) + tdc[8];
        dc[9]  = DC_MPRED(dc[2], dc[8], dc[3]) + tdc[9];
        dc[10] = DC_MPRED(Ldc[13], Ldc[15], dc[8]) + tdc[10];
        dc[11] = DC_MPRED(dc[8], dc[10], dc[9]) + tdc[11];
        dc[12] = DC_MPRED(dc[3], dc[9], dc[6]) + tdc[12];
        dc[13] = DC_MPRED(dc[6], dc[12], dc[7]) + tdc[13];
        dc[14] = DC_MPRED(dc[9], dc[11], dc[12]) + tdc[14];
        ...
        dc[0]  = DC_MPRED2(Tdc[10], Tdc[11]) + tdc[0];
        dc[1]  = DC_MPRED(Tdc[10], dc[0], Tdc[11]) + tdc[1];
        dc[2]  = DC_MPRED2(dc[0], dc[1]) + tdc[2];
        dc[3]  = DC_MPRED(dc[0], dc[2], dc[1]) + tdc[3];
        dc[4]  = DC_MPRED(Tdc[11], dc[1], Tdc[14]) + tdc[4];
        dc[5]  = DC_MPRED(Tdc[14], dc[4], Tdc[15]) + tdc[5];
        dc[6]  = DC_MPRED(dc[1], dc[3], dc[4]) + tdc[6];
        dc[7]  = DC_MPRED(dc[4], dc[6], dc[5]) + tdc[7];
        dc[8]  = DC_MPRED2(dc[2], dc[3]) + tdc[8];
        dc[9]  = DC_MPRED(dc[2], dc[8], dc[3]) + tdc[9];
        ...
        dc[0]  = DC_MPRED(LTdc[15], Ldc[5], Tdc[10]) + tdc[0];
        dc[1]  = DC_MPRED(Tdc[10], dc[0], Tdc[11]) + tdc[1];
        dc[2]  = DC_MPRED(Ldc[5], Ldc[7], dc[0]) + tdc[2];
        dc[3]  = DC_MPRED(dc[0], dc[2], dc[1]) + tdc[3];
        dc[4]  = DC_MPRED(Tdc[11], dc[1], Tdc[14]) + tdc[4];
        ...
        dc[0] = DC_MPRED2(Ldc[1], Ldc[3]) + tdc[0];
        dc[1] = dc[0] + tdc[1];
        dc[2] = DC_MPRED(Ldc[1], Ldc[3], dc[0]) + tdc[2];
        dc[3] = DC_MPRED(dc[0], dc[2], dc[1]) + tdc[3];
    } else if (!is_luma && (flags & 0x20)) {
        dc[0] = DC_MPRED2(Tdc[2], Tdc[3]) + tdc[0];
        dc[1] = DC_MPRED(Tdc[2], dc[0], Tdc[3]) + tdc[1];
        dc[2] = DC_MPRED2(dc[0], dc[1]) + tdc[2];
        dc[3] = DC_MPRED(dc[0], dc[2], dc[1]) + tdc[3];
    } else if (!is_luma) {
        dc[0] = DC_MPRED(LTdc[3], Ldc[1], Tdc[2]) + tdc[0];
        dc[1] = DC_MPRED(Tdc[2], dc[0], Tdc[3]) + tdc[1];
        dc[2] = DC_MPRED(Ldc[1], Ldc[3], dc[0]) + tdc[2];
        dc[3] = DC_MPRED(dc[0], dc[2], dc[1]) + tdc[3];
    }
