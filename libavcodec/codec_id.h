...
#define AV_CODEC_ID_H266 AV_CODEC_ID_VVC
    ...
    AV_CODEC_ID_ADPCM_TANTALUS,
    AV_CODEC_ID_ADPCM_FMOD,
    AV_CODEC_ID_ADPCM_IMA_NDS,
    AV_CODEC_ID_ADPCM_IMA_MO,
    AV_CODEC_ID_ADPCM_BRR,
    AV_CODEC_ID_ADPCM_NDSP_SI,
    AV_CODEC_ID_ADPCM_NDSP,
    AV_CODEC_ID_ADPCM_NDSP_LE,
    AV_CODEC_ID_ADPCM_NDSP_SI1,
    AV_CODEC_ID_ADPCM_IMA_ZMUSIC,
    AV_CODEC_ID_ADPCM_PROCYON,
    AV_CODEC_ID_ADPCM_DSA,
    AV_CODEC_ID_ADPCM_MPC3,
    AV_CODEC_ID_ADPCM_IMA_DVI,
    AV_CODEC_ID_ADPCM_HEVAG,
    AV_CODEC_ID_ADPCM_CFDF,
    AV_CODEC_ID_ADPCM_IMA_HWAS,
    AV_CODEC_ID_ADPCM_IMA_WAV_MONO,
    ...
    AV_CODEC_ID_ADPCM_IMA_WW,
    AV_CODEC_ID_ADPCM_NXAP,
